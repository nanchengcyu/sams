...
<div id="tb" >
	...
	<div>
		...
		&nbsp;用户名/姓名：&nbsp;<input type="text" name="s_userName" id="s_userName" size="20" onkeydown="if(event.keyCode==13) searchUser()"/>
 ...
 <form id="fm" method="post">
 	<table cellspacing="5px;">
  		...
  		<tr>
  			...
  			<td>&nbsp;&nbsp;</td>
  			<td>部门：</td>
  			<input   name="dept.id"   id="deptid"  type="hidden"  />
